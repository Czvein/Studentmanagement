          ...
          <form action="savestudent.php" method="post" enctype="multipart/form-data">
            ...
            <center>
              <div id="ac">
                ...
                <span>Student LRN: </span><input type="text" style="width:265px; height:30px;" value="MS17-<?php
                $prefix = md5(time() * rand(1, 2));
                echo strip_tags(substr($prefix, 0, 4)); ?>" name="student_id" /><br>
                ...
                <span>Picture:</span><input type="file" name="file" id="file" required><br><br>
                <div>
